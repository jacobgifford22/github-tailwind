        ...
        <div class="repo-stats flex items-center justify-between px-8 py-4">
            ...
            <div class="flex space-x-2">
                <div class="flex text-xs">
                    ...
                    <a href="#" class="border border-gray-400 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1">568</a>
                </div>
                <div class="flex text-xs">
                    <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-center space-x-1">
                        <svg aria-hidden="true" viewBox="0 0 16 16" class="fill-current text-gray-600 w-4">
                    ...
                    <a href="#" class="border border-gray-400 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1">56k</a>
                </div>
                <div class="flex text-xs">
                    <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-center space-x-1">
                        <svg aria-hidden="true" viewBox="0 0 16 16" class="fill-current text-gray-600 w-4">
                    ...
                    <a href="#" class="border border-gray-400 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1">2.8k</a>
                </div>
            </div>
        </div><!-- end repo stats -->
        <ul class="repo-nav border-b border-gray-400 flex items-center px-8 mt-4">
            ...
            <li>
                <a href="#" class="flex items-center border-b border-transparent hover:border-gray-300 transition ease-in-out duration-150 px-4 pb-3">
                    ...
                    <div class="text-xs rounded-lg bg-gray-200 px-2 ml-1">19</div>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center border-b border-transparent hover:border-gray-300 transition ease-in-out duration-150 px-4 pb-3">
                    ...
                    <div class="text-xs rounded-lg bg-gray-200 px-2 ml-1">22</div>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center border-b border-transparent hover:border-gray-300 transition ease-in-out duration-150 px-4 pb-3">
